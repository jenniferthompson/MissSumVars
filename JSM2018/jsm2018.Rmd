...
```{r}
knitr::include_graphics("presfigures/exposure_only.png")
```
...
```{r}
knitr::include_graphics("presfigures/exposure_outcome.png")
```
...
```{r}
knitr::include_graphics("presfigures/brains.png")
```
