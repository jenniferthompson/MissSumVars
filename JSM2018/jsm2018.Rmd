...
date: 'bit.ly/jlt-jsm2018<br><a href="http://github.com/jenniferthompson/MissSumVars"><i class="fab fa-github"></i>&nbsp; jenniferthompson/MissSumVars</a><br><a href="http://twitter.com/jent103"><i class="fab fa-twitter"></i>&nbsp; @jent103</a><br>'
output:
  xaringan::moon_reader:
    chakra: libs/remark-latest.min.js
    css: ["robot-fonts", "css/footers.css", "css/my-theme.css", "default"]
    nature:
...
- Once we have a stronger relationship between the exposure and missingness, though, the differences become more striking. Assuming our missing days are unexposed - the yellow line, effectively *ignoring* the missingness - starts to do really badly in comparison. If there's a strong chance that missingness truly indicates the presence of the exposure - in other words, our missingness is quite informative - then using this "missing = exposed" approach is less biased than trying to impute in our scenario, we had some, but not a ton of covariate data with which to impute.
...
- Henrik Bengetsson and Davis Vaughn have built the future and furrr packages respectively; future allows for parallelization of code, and furrr is built on top of the purrr package for easy iterating in parallel without having to understand much of the technical details at all. These folks' work reduced my run time to probably 1/3 of what it would have been with very little additional effort on my part, and I'm very grateful.
