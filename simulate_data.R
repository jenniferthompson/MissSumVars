...
## If MAR/MNAR, may want to make sure distribution of SOFA is different for
##  missing, non-missing observations
...
## Will add code to extract beta, SD (from which we'll calculate CI)
