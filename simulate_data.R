...
## -- Code from here downwards will go into separate script(s) -----------------
...
# bsoi <- 5 ## Relationship between daily SOI and P(status missing)
...
# 
# ## Fit model on del_df ("ignore", "worst") or del_mids ("delete", "impute")
